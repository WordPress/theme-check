...
class DirectoriesCheck implements themecheck {
	...
	function check( $php_files, $css_files, $other_files) {
		...
		if ($found) {
			$this->error[] = __( "<span class='tc-lead tc-required'>REQUIRED</span>: Please remove any extraneous directories like .git or .svn from the ZIP file before uploading it.", "themecheck" );
			$ret = false;
		}
