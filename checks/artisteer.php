...
class ArtisteerCheck implements themecheck {
	...
	function check( $php_files, $css_files, $other_files) {
		...
		if ( 		
			...
			$this->error[] = "<span class='tc-lead tc-warning'>WARNING</span>: This theme appears to have been auto-generated. Generated themes are not allowed in the themes directory.";
			$ret = false;
		}
