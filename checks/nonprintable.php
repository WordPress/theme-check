	...
	function check( $php_files, $css_files, $other_files) {
		...
		checkcount();
			...
			if ( preg_match('/[\x00-\x08\x0B-\x0C\x0E-\x1F\x80-\xFF]/',$content, $matches) ) {
				...
				$this->error[] = "<span class='tc-lead tc-info'>INFO</span>: Non-printable characters were found in the <strong>{$filename}</strong> file. You may want to check this file for errors.";
			}
		}
