...
class WormCheck implements themecheck {
	...
	function check( $php_files, $css_files, $other_files ) {
		...
		$checks = array(
			...
			'/YW55cmVzdWx0cy5uZXQ=/' => __( 'base64 encoded text found in Search Engine Redirect hack', 'theme-check' ),
			'/\$_COOKIE\[\'yahg\'\]/' => __( 'YAHG Googlerank.info exploit code', 'theme-check' ),
			'/ekibastos/' => __( 'Possible Ekibastos attack <a href="http://z9.io/2008/06/08/did-your-wordpress-site-get-hacked/">[1]</a>', 'theme-check' ),
			'/<script>\/\*(GNU GPL|LGPL)\*\/ try\{window.onload.+catch\(e\) \{\}<\/script>/' => __( 'Possible "Gumblar" JavaScript attack <a href="http://justcoded.com/blog/gumblar-family-virus-removal-tool/">[1]</a>', 'theme-check' ),
